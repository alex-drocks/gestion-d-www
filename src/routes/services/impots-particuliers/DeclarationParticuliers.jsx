          ...
          <div className="flex-row">
            <div>
              ...
              <p>
                ...
                enregistrez le document sur votre ordinateur.
        ...
        <div id="etape2" className="etape">
          ...
          <div className="flex-row">
            <div>
              ...
              <p>
                Vous devez ensuite préparer votre dossier d'impôts en rassemblant
                vos feuillets et pièces justificatives
                nécessaires pour votre déclaration. Pour vous aider à préparer
                votre dossier, voici la liste des feuillets
                et documents les plus fréquents à joindre à votre
        ...
        <div id="etape3" className="etape">
          ...
          <div className="flex-row">
            <div>
              ...
              <p>
                ...
                suivant: (A) par courriel, (B) par la poste, ou (C) en personne.
          ...
          <div className="flex-row">
            <div>
              ...
              <p>
                ...
                dossier de façon électronique. Cela vous
                évite le déplacement et accélère le traitement de votre dossier.
                Pour cela, vous n'avez qu'à nous
                envoyer votre dossier par courriel à l'adresse{" "}
              ...
              <ul>
                <li>
                  <strong>Scannez</strong> (ou prenez en photo) vos feuillets et documents à déclarer (doit être
                  visible).
                </li>
                <li>
                  <strong>Créez un dossier compressé (ZIP)</strong>
                  {" "} et glissez-y tous vos fichiers ainsi que le questionnaire d'impôts que vous avez rempli.
                </li>
                <li><strong>Envoyez-nous</strong> le fichier ZIP par courriel.</li>
              </ul>
              <p>
          ...
          <div className="flex-row">
            <div>
              ...
              <p>
                Si vous souhaitez nous envoyer vos papiers physiquement,
                vous pouvez nous les transmettre par la poste à
                destination de:
              </p>
              <p>
                <i style={{ borderLeft: "1px solid var(light-gray)" }}>
                  Gestion Desroches Inc. <br />
                  1650, Boulevard Goyer Ste-Madeleine<br />
                  Québec, J0H 1S0<br />
                  514-293-0200
                </i>
              </p>
          ...
          <div className="flex-row">
            <div>
              <h3>C) En personne:</h3>
              <p>
                Si vous demeurez sur la Rive-Sud et que vous tenez à
                nous transmettre vos documents en personne,
                vous pouvez venir porter votre dossier d'impôts à notre bureau.
                Par contre, vous devez d'abord nous
          ...
          <div className="flex-row">
            <NotificationCard classNames="align-icon-top">
              <h4 className="blue-text">NOTE POUR PREMIÈRE DÉCLARATION / NOUVEL ARRIVANT:</h4>
              <p>Si vous êtes arrivés au Canada au cours de l'année et/ou que vous produisez votre première d'impôts,
                vous devrez obligatoirement nous transmettre vos papiers par la poste en ou en personne. La raison est
                que pour votre première déclaration de revenu, le gouvernement exige qu'on lui transmette votre
                dossier
                physiquement et non pas de façon électronique. Vous devez donc joindre à votre dossier tous vos
                feuillets et factures et nous les transmettre physiquement par la poste ou en personne.
              </p>
            </NotificationCard>
          </div>
        </div>
        ...
        <div id="etape4" className="etape">
          ...
          <div className="flex-row">
            <div>
              ...
              <p>
                À partir du moment que nous avons reçu votre dossier (physique ou numérique), vous devez compter un
                délai
          ...
          <div className="flex-row">
            <div>
              ...
              <p>
                Nous vous contacterons pour que vous puissiez venir récupérer votre dossier à notre bureau. Nous vous
                remettrons alors:
              </p>
              <RecevoirVosResultatsEtPayer />
            </div>
          ...
          <div className="flex-row">
            <NotificationCard classNames="align-icon-top">
              <h4 className="blue-text">Note importante:
                nous donner l'autorisation de compléter</h4>
              <p>
                Pour que nous puissions transmettre votre déclaration de
                revenu au gouvernement, vous devez absolument
                nous en donner l'autorisation en signant le formulaire TED.
                De plus, vous devez avoir effectué le
                paiement
                complet pour le service de déclaration. Dès que nous aurons
                reçu votre formulaire TED dûment signé ainsi
                que votre paiement, nous transmettrons votre déclaration de
...
function RecevoirVosResultatsEtPayer() {
  return (
    <ul>
      <li><strong>Explication de vos résultats. </strong></li>
      <li><strong>Formulaire TED à signer.</strong> Un formulaire à signer et à nous retourner pour nous
        autoriser à transmettre votre déclaration par Internet au gouvernement.
      </li>
      <li><strong>Votre déclaration de revenu en format imprimé.</strong></li>
      <li><strong>Facture à payer. </strong> La facture à payer pour nos services,
        est payable par en argent ou
        par virement interac tel qu'indiqué sur celle-ci
        (référez-vous à votre facture pour savoir comment nous payer).
      </li>
    </ul>
  );
}