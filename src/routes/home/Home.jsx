      ...
      <div className="content-block spacer-top">
        <div className="flex-col flex-col--50w flex--justify-left">
          ...
          <p>
            ...
            et maintenant, chaque personne de la famille Desroches possède
            un rôle au sein de l'entreprise.
            Aujourd'hui, nous desservons plus de {nombreClients} clients
            individuels et commerciaux pour des dossiers de tenue de livres,
            services de paie, fiscalités et conseils personnalisés.
          </p>
